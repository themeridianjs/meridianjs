...
export const GET = async (req: any, res: Response) => {
  ...
  // For workspace-restricted users, check their workspace membership role
  ...
  // If filtering by a specific workspace, check if user is workspace admin
  ...
  // Member: filter by explicit project access
