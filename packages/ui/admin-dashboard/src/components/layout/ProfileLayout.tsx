          ...
          <DropdownMenuTrigger asChild>
            ...
            >
              <Avatar className="h-8 w-8 rounded-lg shrink-0">
                {user?.avatar_url && (
                  <AvatarImage src={user.avatar_url} alt={fullName ?? ""} className="object-cover" />
                )}
          ...
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" className="data-[state=open]:bg-sidebar-accent">
              ...
              <div className="grid flex-1 text-left text-sm leading-tight">
                ...
                <span className="truncate text-xs text-sidebar-foreground/60">Personal settings</span>
              </div>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
