...
import { Users, ArrowLeft, ChevronsUpDown, LogOut } from "lucide-react"
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            ...
            >
              ...
              <div className="grid flex-1 text-left text-sm leading-tight">
                <span className="truncate font-semibold">Team Dashboard</span>
                <span className="truncate text-xs text-sidebar-foreground/60">Member overview</span>
              </div>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
        ...
        <header className="flex h-14 shrink-0 items-center gap-2 border-b w-full">
          <div className="flex w-full items-center gap-1 px-4 lg:gap-2 lg:px-6">
            ...
            <div className="flex items-center gap-2 text-sm">
              <Users className="h-4 w-4 text-indigo-600 dark:text-indigo-400" strokeWidth={1.5} />
